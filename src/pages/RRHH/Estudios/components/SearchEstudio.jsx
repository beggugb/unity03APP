...
const SearchEstudio = () => {
    ...
    const { total }= useSelector(state => state.estudios)
    ...
    const submitHandle = event => {       
      ...
      iok.value = value
      iok.prop  = prop
      dispatch(crudActions.GET_SEARCH('ESTUDIOS_DATA','estudios',iok))      
     }   
    return (                                        
      <Card>          
      <Row>
        ...
        <Col md={2}> 
        <p className="mt-3 ml-3" >{ total || 0 } ESTUDIOS</p>          
        </Col>   
      </Row>
      </Card>               
    );
};
export default SearchEstudio;
