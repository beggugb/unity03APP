...
const SearchHorario = () => {
    ...
    const { total }= useSelector(state => state.horarios)
    ...
    const submitHandle = event => {       
      ...
      iok.value = value
      iok.prop  = prop
      dispatch(crudActions.GET_SEARCH('HORARIOS_DATA','horarios',iok))      
     }   
    return (                                        
      <Card>          
      <Row>
        ...
        <Col md={2}> 
        <p className="mt-3 ml-3" >{ total || 0 } HORARIOS</p>          
        </Col>   
      </Row>
      </Card>               
    );
};
export default SearchHorario;
