...
const SearchSalario = () => {
    ...
    const { total }= useSelector(state => state.salarios)
    ...
    const submitHandle = event => {       
      ...
      iok.value = value
      iok.prop  = prop
      dispatch(crudActions.GET_SEARCH('SALARIOS_DATA','salarios',iok))      
     }   
    return (                                        
      <Card>          
      <Row>
        ...
        <Col md={2}> 
        <p className="mt-3 ml-3" >{ total || 0 } SALARIOS</p>          
        </Col>   
      </Row>
      </Card>               
    );
};
export default SearchSalario;
